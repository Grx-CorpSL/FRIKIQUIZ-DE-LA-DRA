...
// 1. Configuración de voz Web Speech API
...
function verificarRespuesta(seleccion) {
  ...
  const msg = esCorrecto ? respuestasCorrectasAleatorias() : respuestasIncorrectasAleatorias();
  hablar(msg, () => {
...
function respuestasCorrectasAleatorias() {
  const frases = [
...
function respuestasIncorrectasAleatorias() {
  const frases = [
...
// 5. Evento de reinicio y carga inicial
window.onload = () => {
  cargarVoces();
  mostrarPregunta();
